...
import { BookOpen, Database, FileStack, LayoutDashboard, Moon, ScanSearch, Scissors, Settings2, Sun } from 'lucide-react'
    ...
    <aside className={`${
      ...
      <div className="space-y-6">
        <button
          ...
          className="w-full flex items-center gap-2.5 px-1.5 py-1 border-b border-zinc-200 dark:border-zinc-800 pb-4 text-left hover:opacity-80 transition-opacity cursor-pointer focus:outline-none"
        ...
        >
          ...
          {!collapsed && (
            <div className="min-w-0">
              <p className="font-semibold text-xs leading-none text-zinc-900 dark:text-white truncate">智考 Workbench</p>
        ...
        <nav className="space-y-1">
          ...
          <SidebarItem active={location.pathname.startsWith('/questions') && location.pathname !== '/questions/new'} icon={Database} label="题库核心主库" to="/questions" collapsed={collapsed} />
      ...
      <div className="space-y-3 pt-4 border-t border-zinc-200 dark:border-zinc-800">
        <div className={`flex ${collapsed ? 'flex-col gap-2.5 items-center' : 'items-center justify-between'} px-1.5`}>
          <button
