...
import { BookOpen, Check, Settings2, Tags, AlertCircle, LoaderCircle, SlidersHorizontal } from 'lucide-react'
...
export function SettingsPage() {
  ...
  const [activeTab, setActiveTab] = useState<'basic' | 'ocr' | 'classification' | 'prompts'>('basic')
