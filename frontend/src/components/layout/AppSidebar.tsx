...
export function AppSidebar({
  ...
  const menuItems: NavItem[] = [
    ...
    { active: (pathname) => pathname.startsWith('/questions') && pathname !== '/questions/new' && pathname !== '/questions/basket' && pathname !== '/questions/papers' && !pathname.includes('/layout-drafts'), icon: Database, label: '题库', to: '/questions' },
    ...
    { active: (pathname) => pathname === '/questions/papers', icon: FolderOpen, label: '试题中心', to: '/questions/papers' },
    { active: (pathname) => pathname.includes('/layout-drafts'), icon: LayoutTemplate, label: '排版草稿', to: '/questions/layout-drafts' },
    { active: (pathname) => pathname.startsWith('/teaching-documents'), icon: NotebookPen, label: '讲义文档', to: '/teaching-documents' },
