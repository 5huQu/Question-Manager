...
- `frontend/src/utils/teachingDocument/skins/designResolver.ts`: pure Base/explicit-Variant resolver and trusted scoped CSS-variable map. It is not connected to renderer DOM until Phase 2B-1C.
