...
export const TEACHING_DOM = {
  ...
  /** 仅测量树中的续页装饰探针；不参与普通文档的视觉布局。 */
  boxContinuationLabelProbe: 'data-teaching-box-continuation-label-probe',
  boxContinuationHeaderProbe: 'data-teaching-box-continuation-header-probe',
  ...
  questionChoiceLayout: 'data-teaching-question-choice-layout',
  questionChoiceLayoutBlockId: 'data-teaching-question-choice-layout-block-id',
  ...
  rawMarkdownSegment: 'data-teaching-rawmarkdown-segment',
