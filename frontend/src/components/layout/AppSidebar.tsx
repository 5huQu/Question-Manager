...
export function AppSidebar({
  ...
  const menuItems: NavItem[] = [
    ...
    { active: (pathname) => pathname.startsWith('/questions') && pathname !== '/questions/new' && pathname !== '/questions/basket' && !pathname.includes('/layout-drafts'), icon: Database, label: '题库', to: '/questions' },
